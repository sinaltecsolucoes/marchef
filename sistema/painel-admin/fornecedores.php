...
<div class="row mb-3">
    <div class="col-md-6">
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="filtro_situacao_forn" id="filtro-situacao-todos-forn" value="Todos" checked>
            <label class="form-check-label" for="filtro-situacao-todos-forn">Todos</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="filtro_situacao_forn" id="filtro-situacao-ativo-forn" value="A">
            <label class="form-check-label" for="filtro-situacao-ativo-forn">Ativo</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="filtro_situacao_forn" id="filtro-situacao-inativo-forn" value="I">
...
<!-- ============================================================================== -->
<div class="modal fade" id="modal-adicionar-fornecedor" tabindex="-1" aria-labelledby="modal-adicionar-fornecedor-label" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs" id="fornecedorTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="dados-fornecedor-tab" data-tab-target="#dados-fornecedor" type="button" role="tab">Dados Principais</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="enderecos-fornecedor-tab" data-tab-target="#enderecos-fornecedor" type="button" role="tab">Endereços Adicionais</button>
                    </li>
                </ul>
                        ...
                        <form id="form-fornecedor" class="mt-3">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="ent_tipo_pessoa" id="tipo-pessoa-fisica-forn" value="F" checked>
                                        <label class="form-check-label" for="tipo-pessoa-fisica-forn">Física</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="ent_tipo_pessoa" id="tipo-pessoa-juridica-forn" value="J">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="cpf-cnpj-forn" name="ent_cpf_cnpj" required>
                                        <button class="btn btn-outline-secondary" type="button" id="btn-buscar-cnpj-forn" style="display: none;">Buscar Dados</button>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="razao-social-forn" class="form-label">Razão Social / Nome Completo</label>
                                    <input type="text" class="form-control" id="razao-social-forn" name="ent_razao_social" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="nome-fantasia-forn" class="form-label">Nome Fantasia / Apelido</label>
                                    <input type="text" class="form-control" id="nome-fantasia-forn" name="ent_nome_fantasia">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="ent_tipo_entidade" id="tipo-entidade-fornecedor-forn" value="Fornecedor" checked>
                                        <label class="form-check-label" for="tipo-entidade-fornecedor-forn">Fornecedor</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="ent_tipo_entidade" id="tipo-entidade-ambos-forn" value="Cliente e Fornecedor">
                                ...
                                <div class="col-md-6 mb-3" id="div-inscricao-estadual-forn">
                                    ...
                                    <input type="text" class="form-control" id="inscricao-estadual-forn" name="ent_inscricao_estadual">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="logradouro-endereco-forn" name="end_logradouro">
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-9 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="complemento-endereco-forn" name="end_complemento">
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="uf-endereco-forn" name="end_uf" maxlength="2">
                                </div>
                            </div>
                        ...
                        <form id="form-endereco-forn" class="mt-3 border p-3 rounded bg-light">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="tipo-endereco-forn" name="end_tipo_endereco" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="cep-endereco-adicional-forn" name="end_cep" placeholder="00000-000">
                                        <button class="btn btn-outline-secondary" type="button" id="btn-buscar-cep-adicional-forn">Buscar</button>
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="logradouro-endereco-adicional-forn" name="end_logradouro">
                            </div>
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="numero-endereco-adicional-forn" class="form-label">Número</label>
                                    <input type="text" class="form-control" id="numero-endereco-adicional-forn" name="end_numero">
                                </div>
                                <div class="col-md-8 mb-3">
                                    <label for="complemento-endereco-adicional-forn" class="form-label">Complemento</label>
                                    <input type="text" class="form-control" id="complemento-endereco-adicional-forn" name="end_complemento">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-5 mb-3">
                                    <label for="bairro-endereco-adicional-forn" class="form-label">Bairro</label>
                                    <input type="text" class="form-control" id="bairro-endereco-adicional-forn" name="end_bairro">
                                </div>
                                <div class="col-md-5 mb-3">
                                    <label for="cidade-endereco-adicional-forn" class="form-label">Cidade</label>
                                    <input type="text" class="form-control" id="cidade-endereco-adicional-forn" name="end_cidade">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="uf-endereco-adicional-forn" class="form-label">UF</label>
                                    <input type="text" class="form-control" id="uf-endereco-adicional-forn" name="end_uf" maxlength="2">
                                </div>
                            </div>
                            
                            <button type="submit" class="btn btn-success" id="btn-salvar-endereco-forn">Salvar Endereço Adicional</button>
                            <button type="button" class="btn btn-secondary" id="btn-cancelar-edicao-endereco-forn">Limpar / Cancelar</button>
                        </form>
...
<div class="modal fade" id="modal-confirmar-exclusao-endereco-forn" tabindex="-1" aria-hidden="true">
     <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Não</button>
                <button type="button" class="btn btn-danger" id="btn-confirmar-exclusao-endereco-forn">Sim, Excluir</button>
            </div>
        </div>
    </div>
</div>
