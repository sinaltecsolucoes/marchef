...
<h4 class="fw-bold mb-3">Clientes</h4> <!-- Título em sua própria linha com margem inferior -->

<!-- Botão Adicionar Cliente (replicando o layout de usuários) -->
<a href="#" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modal-adicionar-cliente" id="btn-adicionar-cliente-main">Adicionar Cliente</a>
...
<div class="table-responsive">
    <!-- ID da tabela alterado para 'example-clientes' para evitar conflito com 'example' de usuários -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="enderecos-tab" data-bs-toggle="tab" data-bs-target="#enderecos" type="button" role="tab" aria-controls="enderecos" aria-selected="false">Endereços</button>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="dados-cliente" role="tabpanel" aria-labelledby="dados-cliente-tab">
                        <form id="form-cliente">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" id="razao-social" name="ent_razao_social" placeholder="Razão Social ou Nome Completo" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="ent_tipo_entidade" id="tipo-entidade-cliente" value="Cliente" checked>
                                    <label class="form-check-label" for="tipo-entidade-cliente">Cliente</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="ent_tipo_entidade" id="tipo-entidade-fornecedor" value="Fornecedor">
                    ...
                    <div class="tab-pane fade" id="enderecos" role="tabpanel" aria-labelledby="enderecos-tab">
                        <form id="form-endereco" class="mt-3">
                            ...
                            <input type="hidden" id="end-entidade-id" name="end_entidade_id"> <!-- ID da entidade associada -->
                            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf_token ?? ''); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="cep-endereco" name="end_cep" placeholder="00000-000">
                                    <button class="btn btn-outline-secondary" type="button" id="btn-buscar-cep-endereco">Buscar CEP</button>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="logradouro-endereco" name="end_logradouro" placeholder="Rua, Avenida, etc.">
                            </div>

                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="numero" class="form-label">Número</label>
                                    <input type="text" class="form-control" id="numero-endereco" name="end_numero" placeholder="Número">
                                </div>
                                <div class="col-md-8 mb-3">
                                    <label for="complemento" class="form-label">Complemento</label>
                                    <input type="text" class="form-control" id="complemento-endereco" name="end_complemento" placeholder="Apto, Bloco, etc. (Opcional)">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="bairro-endereco" name="end_bairro" placeholder="Bairro">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="cidade" class="form-label">Cidade</label>
                                    <input type="text" class="form-control" id="cidade-endereco" name="end_cidade" placeholder="Cidade">
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary" id="btn-salvar-endereco">Salvar Endereço</button>
                            <button type="button" class="btn btn-secondary" id="btn-cancelar-edicao-endereco">Cancelar</button>
                        </form>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" form="form-cliente" class="btn btn-primary" id="btn-submit-cliente-modal">Salvar Cliente</button>
...
<div class="modal fade" id="modal-confirmar-exclusao-endereco" tabindex="-1" role="dialog" aria-labelledby="modal-confirmar-exclusao-endereco-label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
