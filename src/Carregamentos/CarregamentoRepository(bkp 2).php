        ...
        $sql = "
           SELECT
                ...
                CONCAT('Lote: ', COALESCE(lnh.lote_completo_calculado, 'Avulso'), ' | Saldo: ', 
                    CAST((COALESCE(lne.item_emb_qtd_sec, 0) - COALESCE(lne.item_emb_qtd_finalizada, 0)) AS DECIMAL(10,3))) AS text
            ...
            WHERE lne.item_emb_prod_sec_id = :produto_id
                AND (COALESCE(lne.item_emb_qtd_sec, 0) - COALESCE(lne.item_emb_qtd_finalizada, 0)) > 0
