            ...
            <div class="modal-body">
                ...
                <div class="tab-content border border-top-0 p-3" id="tabLoteUnificadoContent">
                    ...
                    <div class="tab-pane fade" id="aba-detalhes-recebimento" role="tabpanel">
                        <?php include 'partials/form_detalhes_recebimento.php'; // Sugestão: separar em partial se quiser, ou colar o HTML direto aqui 
                        ?>
                    </div>
...
<div class="modal fade" id="modal-finalizar-lote" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Finalizar Itens do Lote</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
            </div>
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-sm table-bordered">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-center">Qtd. a Finalizar</th>
                                <th class="text-center">
                                    <input class="form-check-input" type="checkbox" id="check-finalizar-todos">
                                </th>
                            </tr>
                        </thead>
                        <tbody id="tabela-itens-para-finalizar"></tbody>
                    </table>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-success" id="btn-confirmar-finalizacao">Confirmar</button>
            </div>
        </div>
    </div>
</div>